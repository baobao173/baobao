...
本次从官方重新下载 411,883 行，清洗后 372,578 行。与旧版本的数量差异同时涉及官方文件变动和清洗修正，来源文件哈希记录在 `output/tables/data_quality.json`。
...
这些分组是记录分析标签，没有红黄绿信号含义。涉及五辆及以上车辆的事故只称为“多车辆事故”，不能据此识别连环追尾、二次事故或群死群伤。
