...
数据来源说明（写入 README / 复试讲解）
--------------------------------------
Open-Meteo 历史天气 API（https://open-meteo.com/）：
  * 数据基于 ECMWF ERA5 再分析产品（学术研究常用的权威气象数据）+ 站点观测同化；
  * 免费、无需注册、可按经纬度任意取点，请求可直接复现。
本脚本取纽约中央公园附近坐标 (40.7794, -73.9692)，逐小时返回温度/降水/风速/天气码。

输出：data/raw/weather_2019_0508.csv（含当地时间、温度、降水、风速、天气分类）
用法：
    python src/weather_download.py [--start 2019-05-01] [--end 2019-08-31]
"""
...
WMO_MAP = {
    ...
    61: "雨", 63: "雨", 65: "大雨", 66: "雨", 67: "雨",
    71: "雪", 73: "雪", 75: "雪", 77: "雪",
    80: "阵雨", 81: "阵雨", 82: "大雨", 85: "雪", 86: "雪",
    95: "雷雨", 96: "雷雨", 99: "雷雨",
}
...
def main() -> int:
    ...
    parser.add_argument("--out", type=Path, default=Path("data/raw/weather_2019_0508.csv"))
